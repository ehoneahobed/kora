---
title: v0.5 Internal Beta
description: "Kora.js v0.5 internal beta: convergence correctness, the ApplyPipeline, and the release gates behind the milestone."
---
...
See the best-in-class implementation plan (retired; all 92 items complete) (92/92 complete). Next milestone: [v0.6 public beta](./v0.6-public-beta.md).
